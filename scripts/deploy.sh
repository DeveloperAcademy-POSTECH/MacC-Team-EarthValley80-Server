...
nohup java -jar \
    -Dspring.config.location=classpath:/application.yml,/home/ec2-user/app/deploy/env.properties,/home/ec2-user/app/deploy/application-devRds.yml\
    -Dspring.profiles.active=local-postgresql,dev,jwt,devRds\
